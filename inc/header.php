					...
					<?php if($_SESSION['user'] == "admin") : //Verifica se está logado como adimin ?>
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
								<i class="fa-soldi fa-users"></i> Usuário
							</a>
							<ul class="dropdown-menu">
								<li><a href="<?php echo BASEURL; ?>usuarios"> Adicionar Usuário</a></li>
								<li><a href="<?php echo BASEURL; ?>usuarios/add.php"><i class="fa-soldi fa-users"></i> Gerenciar Usuário</a></li>
							</ul>
						</li>
				<?php endif; ?>
					<li class="nav-item">
